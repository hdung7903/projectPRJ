 ...
 * @author leduy
 */
public class StudentSessionViewController extends StudentAuthorization {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("../student/studentsessionview.jsp").forward(request, response);
    } 
