...
import controller.lecture.TimeTableController;
 ...
 * @author leduy
 */
public class StudentTimeTableController extends StudentAuthorization {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Session> sessions = sessDB.getStudentSession(stuid, dates.get(0), dates.get(dates.size() - 1));

        for (Session session : sessions) {
            System.out.println("Session ID: " + session.getId());
            System.out.println("Date: " + session.getDate());
            System.out.println("Is Attendance: " + session.isIsAtt());
            System.out.println("Room ID: " + session.getRoom().getRid());
            System.out.println("Time Slot ID: " + session.getTime().getId());
