    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="container mt-3">
                ...
                <form action="${pageContext.request.contextPath}/student/schedule" method="GET" class="form-inline justify-content-center mb-3">
                                                    ...
                                                    <c:forEach var="d" begin="${(tableIndex - 1) * 7}" end="${tableIndex * 7 - 1}" items="${dates}">
                                                        <td>
                                                            <c:forEach items="${requestScope.sessions}" var="ses">
                                                                <c:if test="${ses.time.id eq s.id and ses.date eq d}">
                                                                    <div class="mb-2">
                                                                        <a href="${pageContext.request.contextPath}/session/sessiondetail?id=${ses.id}" class="font-weight-bold text-dark">
                                                                            ${ses.group.name} - ${ses.subject.name}
                                                                        </a>
                                                                        <br>
                                                                        <small>at ${ses.room.rid}</small>
